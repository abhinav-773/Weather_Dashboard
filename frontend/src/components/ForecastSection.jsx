...
export default function ForecastSection({ data, loading }) {
  if (loading) {
    return (
      <section aria-label="5-day forecast loading" className="animate-fade-in">
        <h3 className="text-slate-700 dark:text-white/70 text-sm font-semibold uppercase tracking-wider mb-3">
          5-Day Forecast
        </h3>
  ...
  return (
    <section aria-label="5-day weather forecast" className="animate-fade-in">
      <h3 className="text-slate-700 dark:text-white/70 text-sm font-semibold uppercase tracking-wider mb-3 flex items-center gap-2">
